...
def main() -> int:
    ...
    for required in (
        ...
        "print_policy_output_count_min = 1_int64",
        "print_policy_output_count_max = 10_int64",
        ...
        "print_policy_expression_4_left = 'x'",
        "print_policy_expression_4_right = '2'",
        "print_policy_expression_4_source = &",
        "print_policy_expression_5_operator = '**'",
        "print_policy_expression_5_left = 'x'",
        "print_policy_expression_5_right = 'x'",
        "print_policy_expression_5_source = &",
        "print_policy_power_operator = '**'",
        "print_policy_power_left = 'x'",
        "print_policy_power_min = 2_int64",
        "print_policy_power_max = 10_int64",
        "l3-raw-program-generic-print-expression-v0",
        "value%output_count > print_policy_output_count_max",
    ):
