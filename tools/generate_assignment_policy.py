...
def main() -> int:
    ...
    (output / "frontend_assignment_policy_generated.f90").write_text(
        ...
        "        ]\n"
        f"    integer, parameter, public :: assignment_policy_integer_literal_min = {match.group(50)}\n"
        f"    integer, parameter, public :: assignment_policy_integer_literal_max = {match.group(51)}\n"
