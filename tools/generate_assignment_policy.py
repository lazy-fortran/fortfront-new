...
def main() -> int:
    ...
    (output / "frontend_assignment_policy_generated.f90").write_text(
        ...
        "    integer, parameter, public :: assignment_policy_sequence_max_count = 4\n"
        ...
        f"        assignment_policy_sequence_row_t('{match.group(39)}', '{match.group(40)}', '{match.group(41)}', '{match.group(42)}', '{match.group(43)}') &\n"
        "        ]\n"
        f"    integer, parameter, public :: assignment_policy_integer_literal_min = {match.group(44)}\n"
        f"    integer, parameter, public :: assignment_policy_integer_literal_max = {match.group(45)}\n"
